...
describe("Ejercicio 7b - Herencia (Table Per Class)", () => {
  beforeAll(async () => {
    await initializeDatabase("ej07b");
  });
  ...
  it("crea cada subtipo con sus campos propios, en su propia tabla", async () => {
  ...
  it("lista todos los tracks combinando las tres tablas", async () => {
    await createSong({
      title: "A",
      durationSeconds: 200,
      albumTitle: "X",
